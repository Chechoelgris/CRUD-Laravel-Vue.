<template>
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 mb-5  bg-dark text-light collapse" id="collapseExample">
             <table class="table table-striped table-dark table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            <th scope="col">Ir</th>
                            <th scope="col">Nombre</th>
                            <th scope="col">Raza / Clase</th>
                     ...
                     <tbody>
                        <tr v-for="(personaje, index) in personajes" :key="index">
                            <th scope="row"><a href="" class="btn btn-info btn-sm" >Ver</a></th>
                            <td>{{personaje.nombre}}</td>
                            <td>{{personaje.raza}} / {{personaje.clase}}</td>
